...
import { Calendar, User, MapPin, Eye, ChevronLeft, ChevronRight } from 'lucide-react';
...
const CategoryNews: React.FC = () => {
  ...
  const validCategories = [
    'trending', 'chandigarh', 'punjab', 'india', 'world', 
  ...
  // Regions for filter
  const regions = [
    'all', 'amritsar', 'ludhiana', 'jalandhar', 'patiala', 'bathinda', 
    'mohali', 'chandigarh', 'gurdaspur', 'hoshiarpur'
  ];
                ...
                <div className="relative h-64 md:h-80">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-300">
                      ...
                      <span>{formatDate(featuredArticles[currentFeatured].publishDate)}</span>
                      {featuredArticles[currentFeatured].views && (
                        <span>{featuredArticles[currentFeatured].views} views</span>
                      )}
                    </div>
                  </div>
                  ...
                  {featuredArticles.length > 1 && (
                    <>
                      <Button
                        onClick={() => setCurrentFeatured(prev => 
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <div className="space-y-2">
                  {['Politics', 'Sports', 'Technology', 'Health', 'Entertainment'].map((topic) => (
                    <Link
                      key={topic}
